...
const getAllLessonCommentaires ="SELECT users.nom, users.prenom, users.photo, commentaire.intitule,commentaire.id_commentaire FROM commentaire JOIN users ON users.id=commentaire.users_id WHERE commentaire.lecon_id=$1 ORDER BY commentaire.created_at DESC;"; 
