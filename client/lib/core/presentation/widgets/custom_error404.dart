...
class CustomError404 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
                    children: [
                      Image.asset(ImageConstant.error404, width: 300.h,),
                      Text(appLocalization!.lbl_oops_something_went_wrong, style: theme.textTheme.titleLarge!.copyWith(color: Colors.black),),
                SizedBox(height: 17.v),
                      Text(appLocalization.lbl_please_try_again, style: theme.textTheme.bodySmall!.copyWith(color: Colors.grey),textAlign: TextAlign.center,),
                SizedBox(height: 17.v),


                      CustomElevatedButton(text: appLocalization.lbl_try_again, onPressed: onPressed,)
                    ],
                  );
  }
}